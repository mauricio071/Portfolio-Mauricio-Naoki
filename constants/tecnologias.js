...
export const tecnologias = [
    { logo: IconSkillsLogoHtml, nome: "HTML5" },
    { logo: IconSkillsLogoCss, nome: "CSS3" },
    { logo: IconSkillsLogoJavascript, nome: "JavaScript" },
    { logo: IconSkillsLogoTypeScript, nome: "TypeScript" },
    { logo: IconSkillsLogoVue, nome: "Vue.js" },
    { logo: IconSkillsLogoNuxt, nome: "Nuxt.js" },
    { logo: IconSkillsLogoVuetify, nome: "Vuetify" },
    { logo: IconSkillsLogoReact, nome: "React.js" },
    { logo: IconSkillsLogoBootstrap5, nome: "Bootstrap" },
    { logo: IconSkillsLogoTailwind, nome: "Tailwind" },
    { logo: IconSkillsLogoSass, nome: "SASS" },
    { logo: IconSkillsLogoGit, nome: "Git" },
    { logo: IconSkillsLogoNode, nome: "Node.js" },
];
