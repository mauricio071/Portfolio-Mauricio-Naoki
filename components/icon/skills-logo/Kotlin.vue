<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2501.34 2500">
        <radialGradient id="a" cx="2329.27" cy="2305.82" gradientTransform="matrix(1.09 0 0 -1.09 -110.8 2605.56)"
