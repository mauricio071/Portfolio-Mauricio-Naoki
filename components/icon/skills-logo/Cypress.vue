<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="6.5 6.4 950.1 948.5">
        <defs>
            <linearGradient id="grad-a" gradientUnits="userSpaceOnUse" x1="992.991" x2="568.87" y1="483.702"
                y2="758.304">
                <stop offset=".081" stop-color="#69d3a7" />
                <stop offset="1" stop-color="#69d3a7" stop-opacity="0" />
            </linearGradient>
            <linearGradient id="grad-b" gradientUnits="userSpaceOnUse" x1="323.384" x2="56.936" y1="12.396"
                y2="577.503">
                <stop offset="0" stop-color="#69d3a7" />
                <stop offset=".823" stop-color="#2ab586" />
                <stop offset="1" stop-color="#1cae7f" />
            </linearGradient>
            <linearGradient id="grad-c" gradientUnits="userSpaceOnUse" x1="5.828" x2="704.494" y1="697.848"
                y2="917.116">
