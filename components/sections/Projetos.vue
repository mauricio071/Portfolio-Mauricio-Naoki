                            ...
                            <div class="detalhes">
                                ...
                                <div class="detalhes-links">
                                    <template v-if="modal.urlProjeto && modal.urlProjeto.includes('instalador')">
                                        <a :href="modal.urlProjeto" target="_blank" rel="noreferrer"
                                            aria-label="Instalador">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                fill="currentColor" class="w-[1.5rem] lg:w-[2rem]">
                                    ...
                                    <template v-else>
                                        <a v-if="modal.urlProjeto" :href="modal.urlProjeto" target="_blank"
                                            rel="noreferrer" aria-label="Projeto Online">
