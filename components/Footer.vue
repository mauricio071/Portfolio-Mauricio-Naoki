...
<style scoped>
footer {
    @apply relative text-white px-4 py-6 lg:py-5;
    ...
    .footer-container {
        @apply container relative mx-auto flex flex-col items-center justify-center gap-5 z-[5];
